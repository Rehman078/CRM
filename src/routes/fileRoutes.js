...
router.get('/:id', protect, authorizeRoles("Admin", "Manager", "SalesRep"), fileController.getFilesBySourceId);
router.put('/update', protect, authorizeRoles("Admin", "Manager", "SalesRep"), upload.array('files', 10), fileController.updateFile);
